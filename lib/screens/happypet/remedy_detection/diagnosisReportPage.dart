...
class DiagnosisReportPage extends StatefulWidget {
  ...
  List<HabitualQuestion> answeredHabitualQuestionList;
  String suspectedDiseaseFromHabits;

  DiagnosisReportPage({Key? key, this.petID, this.userID, required this.diseaseList, required this.imageAnalysis, required this.answeredObservationQuestionList, required this.suspectedDiseaseFromObservations,
    required this.answeredHabitualQuestionList, required this.suspectedDiseaseFromHabits}) : super(key: key);

  @override
  _DiagnosisReportPageState createState() => _DiagnosisReportPageState(petID, userID, diseaseList, imageAnalysis, answeredObservationQuestionList, suspectedDiseaseFromObservations, answeredHabitualQuestionList, suspectedDiseaseFromHabits);
}
...
class _DiagnosisReportPageState extends State<DiagnosisReportPage> {
  ...
  _DiagnosisReportPageState(this.petID, this.userID, this.diseaseList, this.imageAnalysis, this.answeredObservationQuestionList, this.suspectedDiseaseFromObservations, this.answeredHabitualQuestionList, this.suspectedDiseaseFromHabits);
  ...
  String suspectedDisease = 'Not Found';

  @override
  void initState() {
    List<AnalysedImageDisease> analysedSuspectedDiseaseList =  [];
    imageAnalysis.analysedImageDisease.forEach((element) {
      if(element.diseaseName == suspectedDiseaseFromObservations || element.diseaseName == suspectedDiseaseFromHabits){
        if(!analysedSuspectedDiseaseList.contains(element)){
          analysedSuspectedDiseaseList.add(element);
        }
      }
    });

    if(analysedSuspectedDiseaseList.length != 0){
      suspectedDisease = analysedSuspectedDiseaseList.first.diseaseName;
      print("Final Suspected Disease : " + suspectedDisease);
    }
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            'Detected Disease - $suspectedDisease',
                                            style: TextStyle(
                                        ...
                                        child: Padding(
                                          ...
                                          child: RichText(
                                            ...
                                            text: TextSpan(
                                              ...
                                              text: "$suspectedDisease ($suspectedDisease) is a bacterial infection of the skin that is most common in young children. Doctors use antibiotics to treat $suspectedDisease. Antibiotics can also help protect others from getting sick",
                                              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: COLOR_BLACK),
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                          '1. Place the cut side of a garlic directly on $suspectedDisease sores / place a slice of ginger',
                                                          style: TextStyle(
                                                              fontWeight: FontWeight.bold
                                                          ),
                                                        ),
